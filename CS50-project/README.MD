...
- Note that all new users will be designated *viewer* status and, if necessary, will need to have their designation raised by an admin editting the User's table
